...
def handle_client(client_socket, base_dir):
    try:
        ...
        # de uma só vez.
        # request_text armazena todas as informacoes da requisicao GET /index.htmla HTTP/1.1, host, ...
...
def log_request(client_socket, request_text, status, log_file):
    ...
    # Obter o código do resultado (que você precisa determinar com base na solicitação)
